...
#initialisation des 9 pions avec les valeurs de position numerique, des 2 variables player_win et des 2 tableaux de position(pion simple pour les test , pion coloré pour l'affichage)
	...
	#definition de la ligne1 
	def line1
		puts " " * 6 + " ." + " " * 6 + " ." + " " * 6
	end
	#definition de la ligne2 qui recoit les pions
	def line2(a, b, c)
		puts " " * 3 + a + " " * 2 + " ." + " " * 3 + b + " " * 2 + " ." + " " * 3 + c + " " * 2 
	end
  #definition de la ligne3
	def line3
		puts " ." * 11
	end
	...
	def print_board		
		line1
		line2(@pos[0].case, @pos[1].case, @pos[2].case)
		line1
		line3
		line1
		line2(@pos[3].case, @pos[4].case, @pos[5].case)
		line1
		line3
		line1
		line2(@pos[6].case, @pos[7].case, @pos[8].case)
		line1
	end
